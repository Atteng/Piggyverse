                ...
                <div className="md:hidden flex items-center gap-2">
                    <div className="flex items-center gap-1.5 mr-2">
                        <Link href={pathname.startsWith('/competitive-hub') ? "/competitive-hub/host" : "/library/submit"}>
                            <Button size="icon" style={{ color: '#ff2f7a' }} className="h-9 w-9 rounded-full bg-white hover:bg-white/90 shadow-lg transition-all active:scale-95 flex items-center justify-center p-0">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" style={{ color: '#ff2f7a' }} className="bg-black/60 backdrop-blur-md border border-white/10 rounded-full px-4 text-piggy-label font-black flex items-center gap-2 h-10 shadow-lg min-w-[120px] justify-between hover:bg-black/80 transition-all active:scale-95">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="uppercase tracking-widest whitespace-nowrap">
                                        {(() => {
                                            ...
                                            if (pathname.startsWith("/competitive-hub")) return "Contests";
                                ...
                                <div className="w-0 h-0 border-l-[4px] border-l-transparent border-r-[4px] border-r-transparent border-t-[4px] border-t-[#ff2f7a] ml-0.5" />
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent className="w-64 bg-black/60 backdrop-blur-3xl border border-white/5 text-white rounded-2xl p-2 shadow-2xl" align="end" sideOffset={8}>
                            ...
                            <div className="grid gap-0.5">
                                <Link href="/">
                                    <DropdownMenuItem className={cn(
                                        "cursor-pointer rounded-xl px-3 py-2.5 font-bold text-piggy-label flex items-center gap-3 transition-colors",
                                        pathname === "/"
                            ...
                            <Link href="/piggy-club">
                                <DropdownMenuItem className="cursor-pointer hover:bg-white/10 rounded-xl focus:bg-white/10 focus:text-white px-3 py-2.5 font-bold text-piggy-label flex items-center gap-3 text-piggy-pink">
                    ...
                    {status === "loading" ? (
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="relative h-10 w-10 md:h-12 md:w-12 rounded-full p-0.5 overflow-hidden bg-black/60 border border-white/10 hover:bg-black/80 transition-all hover:scale-105 shadow-xl flex items-center justify-center shrink-0">
                                    <Avatar className="h-full w-full rounded-full overflow-hidden">
                                        ...
                                        <AvatarFallback className="h-full w-full bg-[var(--color-piggy-deep-pink)] text-white rounded-full text-piggy-title font-bold flex items-center justify-center">
                            ...
                            <DropdownMenuContent className="w-56 bg-black/60 border border-white/5 text-white backdrop-blur-3xl rounded-2xl p-2 shadow-2xl" align="end" sideOffset={8}>
                                <DropdownMenuLabel className="font-mono text-xs text-gray-400 font-bold tracking-tight mb-2 px-2">
                                    {displayName}
                                </DropdownMenuLabel>
                        ...
                        <Button
                            ...
                            className="bg-[var(--color-piggy-deep-pink)] hover:bg-[var(--color-piggy-deep-pink)]/80 text-white rounded-full font-bold px-4 md:px-8 h-10 md:h-12 text-piggy-label md:text-piggy-body shadow-[0_0_20px_rgba(255,47,122,0.4)] transition-all hover:scale-105 shrink-0"
                        >
                ...
                <div className="hidden md:flex items-center gap-6 ml-auto">
                    ...
                    <div className="flex items-center gap-3 md:gap-6">
                        ...
                        <div className="relative group hidden lg:block">
                            ...
                            <input
                                ...
                                className="w-[320px] h-12 pl-12 pr-4 bg-black/40 backdrop-blur-3xl border border-white/5 text-white placeholder:text-white/20 rounded-2xl focus:outline-none focus:border-white/20 focus:ring-1 focus:ring-white/10 transition-all text-piggy-body font-medium shadow-2xl relative z-0"
                            />
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            <Link href={pathname.startsWith('/competitive-hub') ? "/competitive-hub/host" : "/library/submit"}>
                                <Button variant="ghost" style={{ color: '#ff2f7a' }} className="bg-white hover:bg-gray-100 rounded-full font-black px-6 h-12 text-piggy-body shadow-[0_0_20px_rgba(255,255,255,0.2)] transition-all hover:scale-105 active:scale-95">
                            ...
                            <Link href="/piggy-club">
                                <Button variant="ghost" style={{ color: '#ff2f7a' }} className="bg-white hover:bg-gray-100 rounded-full font-black px-6 h-12 text-piggy-body shadow-[0_0_20px_rgba(255,255,255,0.2)] transition-all hover:scale-105 active:scale-95">
                                    Goto Piggy Club
                                    <ArrowRight className="ml-2 h-4 w-4" style={{ color: '#ff2f7a' }} />
                                </Button>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center">
                        {status === "loading" ? (
                            ...
                            <Button
                                onClick={() => setIsLoginOpen(true)}
                                className="bg-[var(--color-piggy-deep-pink)] hover:bg-[var(--color-piggy-deep-pink)]/80 text-white rounded-full font-bold px-8 h-12 text-piggy-body shadow-[0_0_20px_rgba(255,47,122,0.4)] transition-all hover:scale-105"
                            >
