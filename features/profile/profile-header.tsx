        ...
        <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6">
                ...
                <div className="relative shrink-0">
                    ...
                    {/* Rank Badge */}
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[var(--color-piggy-deep-pink)] text-white text-sm font-bold px-4 py-1 rounded-full border-2 border-black shadow-lg">
                        #{user.globalRank}
                    </div>
                </div>
                ...
                <div className="flex-1 text-center lg:text-left">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full">
                        <span className="text-xs font-bold text-white/60 uppercase tracking-wider">Global Rank</span>
                        <span className="text-lg font-bold text-[var(--color-piggy-deep-pink)]">#{user.globalRank}</span>
                    </div>
                </div>

                {/* Linked Accounts - Right Side */}
                <div className="flex flex-col gap-2 shrink-0">
                    <p className="text-xs text-white/40 uppercase tracking-wider mb-1 text-center lg:text-right">Linked Accounts</p>
                    ...
                    {user.twitterConnected ? (
                        ...
                        >
                            ...
                            <span className="text-xs text-[var(--color-piggy-deep-pink)] font-bold group-hover:text-white transition-colors">
                                Connect Twitter
                            </span>
                        </button>
                    )}
